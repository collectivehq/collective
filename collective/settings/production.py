...
SITE_NAME = os.environ.get("DJANGO_SITE_NAME", SITE_NAME)  # noqa: F405
SITE_DOMAIN = os.environ.get("DJANGO_SITE_DOMAIN", ALLOWED_HOSTS[0] if ALLOWED_HOSTS else SITE_DOMAIN)  # noqa: F405
